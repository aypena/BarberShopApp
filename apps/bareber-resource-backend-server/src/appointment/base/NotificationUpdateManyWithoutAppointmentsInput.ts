...
@InputType()
class NotificationUpdateManyWithoutAppointmentsInput {
...
export { NotificationUpdateManyWithoutAppointmentsInput as NotificationUpdateManyWithoutAppointmentsInput };
