  ...
  test("POST /notifications", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        fechaProgramada: CREATE_RESULT.fechaProgramada.toISOString(),
      });
  });
      ...
      .expect([
        {
          ...
          fechaProgramada: FIND_MANY_RESULT[0].fechaProgramada.toISOString(),
        },
      ]);
  });
  ...
  test("GET /notifications/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        fechaProgramada: FIND_ONE_RESULT.fechaProgramada.toISOString(),
      });
  });
